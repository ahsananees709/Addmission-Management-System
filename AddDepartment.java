...
public class AddDepartment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     //   etdegree.setText("Degree:  " + degree);
        ...
        submitButton2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                department_DBHelper myDB = new department_DBHelper(AddDepartment.this);
                myDB.addDepartment(
                        name,cnic,
                        matric,
                        inter,
                        degree,
                        department);
                Intent intent = new Intent(AddDepartment.this, DepartmentActivity.class);
