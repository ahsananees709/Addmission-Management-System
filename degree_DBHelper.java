...
public class degree_DBHelper extends SQLiteOpenHelper {

    private Context context;
    private static final String DATABASE_NAME = "DegreeData.db";
    private static final int DATABASE_VERSION = 1;
    private static final String TABLE_NAME = "degree_table";
    ...
    degree_DBHelper(@Nullable Context context) {
    ...
    void addDegree(String name, String cnic, String matric, String inter, String degree){
    ...
    void updateData(String row_id, String name, String cnic, String matric, String inter, String degree){
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues cv = new ContentValues();
        cv.put(COLUMN_NAME,name);
        cv.put(COLUMN_CNIC,cnic);
