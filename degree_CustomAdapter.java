...
public class degree_CustomAdapter extends RecyclerView.Adapter<degree_CustomAdapter.MyViewHolder> {

    private Context context;
    Activity activity;

    private ArrayList id,name,cnic,matric,inter,degree;

    degree_CustomAdapter(Activity activity, Context context,ArrayList id,
                              ArrayList name,
                              ArrayList cnic,
                              ArrayList matric,
                              ArrayList inter,
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.degree_row,parent,false);
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.mainLayout_degree.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        TextView tvApplicantDegree;
        LinearLayout mainLayout_degree;
        Button degreeButton;
        public MyViewHolder(@NonNull View itemView) {
            ...
            mainLayout_degree = itemView.findViewById(R.id.mainLayout_degree);
